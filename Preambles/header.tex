...
% Paper example box (orange)
\newtcolorbox{examplebox}[1][Example]{
  beamerbase,
  colback=okabeorange!10,
  colframe=okabeorange,
  coltitle=okabeorange!80!black,
  title={#1},
}

% Warning / caveat box (vermillion)
\newtcolorbox{warningbox}[1][Caution]{
  beamerbase,
  colback=okabevermillion!10,
  colframe=okabevermillion,
  coltitle=okabevermillion!80!black,
  title={#1},
}
